...
/* AI brugt til at finde ud af hvorfor højden ikke kunne ændres med Tailwind, viste sig at være noget default sizing her inde og det er efterfølgende blevet slettet */
	...
	"group/button inline-flex shrink-0 items-center justify-center border-transparent text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				...
				secondary:
					"relative bg-transparent p-4 text-primary-foreground border-t-2 border-b-2 p-4 pr-6 pl-6 border-primary-foreground cursor-pointer",
				highlight:
				...
				grey: "bg-black/50 min-w-[160px] block mt-4 relative to-highlight-accent p-4 pr-6 pl-6 border-(--sidebar-ring) border-2 cursor-pointer after:absolute after:top-0 after:right-0 after:w-5 after:h-5 after:border-t-2 after:border-r-2 after:border-primary-foreground/50 after:opacity-100 after:blur-[1px]",
