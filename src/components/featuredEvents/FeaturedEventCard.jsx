	...
	return (
		<article>
			<Link href={`/book-table?event=${event.id}`}>
				<motion.section className="image-hover relative" initial="rest" whileHover="hover" animate="rest">
					<Image
			...
			<section className="bg-highlight-primary">
				<Link
					...
					className="flex ml-(--space-s) justify-between mr-(--space-s) items-center"
				>
					<p className="">{event.title}</p>
					<p className="text-highlight-secondary">{formattedDate}</p>
				</Link>
			</section>
		</article>
	);
